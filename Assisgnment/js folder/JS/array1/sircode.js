...
let abc = ["this is string", 78457, false, null, [1, 2, 3, 4], 
"vinay"];
const xyz = ["this is not string", 8457, true, undefined, [ 3, 4], "abcd"];
...
console.log("----------",abc)
console.log("-->1 --->", container.length, container);
console.log("-->2 --->", container[10],[0]);
console.log("-->3 --->", container[7][1]);
