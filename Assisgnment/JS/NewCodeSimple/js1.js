...
const school={}
console.log("schoool assign",Object.assign(school,{name:"poonam",class:"PG"}))
console.log(Object.assign({...animals},fish,reptile,school))
  ...
  console.log(`14----> `, poke.results[5]?.name || "");
...
//   console.log(`17----> `, poke2 || {});
  ...
  console.log("19--- newAnimals keys array", Object.keys(school));
  console.log("20--- newAnimals values array", Object.values(school));
  
  console.log("21--- newAnimals values array", Object.entries(school));
