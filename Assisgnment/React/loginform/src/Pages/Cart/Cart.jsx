...
//                 variant="top"
//                 src={itemsSelected?.thumbnail}
//                 alt={itemsSelected?.thumbnail}
//               />
//               <Card.Body>
//                 <Button
//                   variant="light"
...
//           </div>
//           <div>
//             <Card.Title className="product-card__brand">
//               {" "}
//               {itemsSelected?.description}
//             </Card.Title>
//             <Card.Text className="product-card__description"></Card.Text>
//             <Card.Text className="product-card__price"></Card.Text>
//             <Button> {itemsSelected.rating} </Button>Rating
//             <Card.Text>$ {itemsSelected.price}</Card.Text>
